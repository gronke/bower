...
function Project(config, logger, options) {
    ...
    this._options = deepExtend({}, options || {});
    this._manager = new Manager(this._config, this._logger, this._options);
}
...
Project.prototype.install = function (decEndpoints, options, config) {
    ...
    this._options.disableHooks = !!this._options.disableHooks;
    this._config = config || {};
    this._working = true;
